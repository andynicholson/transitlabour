...
def create_profile(request, form_class=None, success_url=None,
    ...
    **Template:**
    ...
    if request.method == 'POST':
	    ...
	    #AN
	    #Save the user's first name, last name and email!
	    profile_obj.user.first_name = request.POST.get('first_name')
	    profile_obj.user.last_name = request.POST.get('last_name')
