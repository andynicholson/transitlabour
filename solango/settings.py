...
SEARCH_UPDATE_URL = getattr(settings, "SEARCH_UPDATE_URL", "http://erko.infiniterecursion.com.au:8984/solr/update")
SEARCH_SELECT_URL = getattr(settings, "SEARCH_SELECT_URL", "http://erko.infiniterecursion.com.au:8984/solr/select")
SEARCH_PING_URLS =  getattr(settings, "SEARCH_PING_URLS", ["http://erko.infiniterecursion.com.au:8984/solr/admin/ping",])
